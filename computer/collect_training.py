                    ...
                    for event in pygame.event.get():
                        if event.type == KEYDOWN:
                            ...
                            if key_input[pygame.K_UP] and key_input[pygame.K_RIGHT]:
                                ...
                                urllib.request.urlopen('http://192.168.0.100:5000/right').read()
                                saved_frame += 1
                                ...
                                saved_frame += 1
                                urllib.request.urlopen('http://192.168.0.100:5000/left').read()

                            elif key_input[pygame.K_DOWN] and key_input[pygame.K_RIGHT]:
                                print("Reverse Right")
                                urllib.request.urlopen('http://192.168.0.100:5000/stop').read()
                            ...
                            # simple orders
                                ...
                                urllib.request.urlopen('http://192.168.0.100:5000/forward').read()

                            elif key_input[pygame.K_DOWN]:
                                print("Reverse")
                                urllib.request.urlopen('http://192.168.0.100:5000/reverse').read()
